...
| --- | --- | --- | --- | --- |
| FR-001 | TC-001 | IMPL-001 | REL-001 | Planned |
...
| FR-012 | TC-012 | IMPL-009 | REL-001 | Planned |
| FR-013 | TC-008 | IMPL-001 | REL-001 | Planned |
...
| --- | --- | --- | --- |
| TC-001 | FR-001, NFR-006 | `tests/unit/test_detection_event.py` | Planned |
...
| TC-008 | FR-013 | `tests/unit/test_detection_event.py` | Planned |
...
| TC-012 | FR-012, NFR-007 | `tests/unit/test_settings.py` | Planned |
...
| --- | --- | --- | --- | --- |
| IMPL-001 | `src/occupant_safety/detection/events.py` | FR-001, FR-013, NFR-006 | TC-001, TC-008 | Planned |
